...
if version < 600
    ...
    highlight NonText   gui=None guibg=#2b303b guifg=LightSkyBlue3
endif
highlight Normal        gui=None guibg=#2b303b guifg=honeydew2
highlight Question      gui=bold  guifg=SeaGreen2 guibg=bg
highlight Search        gui=NONE guibg=LightSkyBlue4 guifg=NONE
highlight SpecialKey    guibg=#2b303b guifg=#324262
