...
let g:light_blue = "8fa1b3"    " #80FCFF
...
call s:X("CursorLineNr",g:light_blue,"","","White","")

call s:X("LineNr","605958",g:cobalt_bg,"none",s:termBlack,"")
call s:X("Comment",g:light_blue,"","italic","Grey","")
...
call s:X("String",g:light_green,"","","Green","")
call s:X("StringDelimiter",g:light_green,"","","Green","")
